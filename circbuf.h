...
static inline void
circ_cleanup (struct circbuf **circ)
{
  circ_free (*circ);
  *circ = NULL;
}
...
static inline bool
circ_empty (const struct circbuf *circ)
{
  return circ->head == circ->tail;
}

static inline unsigned
circ_count (const struct circbuf *circ)
{
  return (circ->tail - circ->head) & (circ->size - 1);
}

static inline unsigned
circ_space (const struct circbuf *circ)
{
  return circ->size - 1 - circ_count (circ);
}

static inline unsigned
circ_count_to_end (const struct circbuf *circ)
{
...
static inline unsigned
circ_space_to_end (struct circbuf *circ)
{
...
static inline void
circ_commit (struct circbuf *circ, unsigned n)
{
...
static inline int
circ_read_u8 (struct circbuf *circ, uint8_t *__restrict buf, unsigned *off)
{
  return circ_read (circ, buf, 1, off);
}

static inline int
circ_read_be16 (struct circbuf *circ, uint16_t *buf, unsigned *off)
{
  uint8_t data[2] = { 0 };
...
static inline int
circ_read_le16 (struct circbuf *circ, uint16_t *buf, unsigned *off)
{
  uint8_t data[2] = { 0 };
...
static inline int
circ_read_be32 (struct circbuf *circ, uint32_t *__restrict buf, unsigned *off)
{
  uint8_t data[4] = { 0 };
...
static inline int
circ_read_le32 (struct circbuf *circ, uint32_t *__restrict buf, unsigned *off)
{
  uint8_t data[4] = { 0 };
...
int circ_write (struct circbuf *circ, const void *__restrict buf,
                unsigned size, unsigned *off);

static inline int
circ_write_u8 (struct circbuf *circ, unsigned value, unsigned *off)
{
  uint8_t data[1];
...
static inline int
circ_write_be16 (struct circbuf *circ, unsigned value, unsigned *off)
{
  uint8_t data[2];
...
static inline int
circ_write_le16 (struct circbuf *circ, unsigned value, unsigned *off)
{
  uint8_t data[2];
...
static inline int
circ_write_be32 (struct circbuf *circ, uint_least32_t value, unsigned *off)
{
  uint8_t data[4] = { 0 };
...
static inline int
circ_write_le32 (struct circbuf *circ, uint_least32_t value, unsigned *off)
{
  uint8_t data[4] = { 0 };
